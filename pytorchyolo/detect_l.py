...
# 执行非极大值抑制（NMS）筛选检测框。
# 输出检测结果和对应的图像路径。
def detect(model, dataloader, output_path, conf_thres, nms_thres, img_size, multiple_min=3):
    ...
    :param img_size: Size of each image dimension for yolo, defaults to 416
    :type img_size: int, optional
    :param multiple_min: minimum allowed size multiple and if bigger than it then cut-handle, defaults to 3
    :type multiple_min: float, optional
